...
${OBJECTDIR}/src/commands/test.o: nbproject/Makefile-${CND_CONF}.mk src/commands/test.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/commands/test.o src/commands/test.cpp

${OBJECTDIR}/src/dif/ApplyInfo.o: nbproject/Makefile-${CND_CONF}.mk src/dif/ApplyInfo.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/dif
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dif/ApplyInfo.o src/dif/ApplyInfo.cpp

${OBJECTDIR}/src/dif/ChangeAttr.o: nbproject/Makefile-${CND_CONF}.mk src/dif/ChangeAttr.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/dif
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dif/ChangeAttr.o src/dif/ChangeAttr.cpp

${OBJECTDIR}/src/dif/EmpirePriv.o: nbproject/Makefile-${CND_CONF}.mk src/dif/EmpirePriv.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/dif
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dif/EmpirePriv.o src/dif/EmpirePriv.cpp

${OBJECTDIR}/src/dif/GuildOfferExp.o: nbproject/Makefile-${CND_CONF}.mk src/dif/GuildOfferExp.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/dif
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dif/GuildOfferExp.o src/dif/GuildOfferExp.cpp

${OBJECTDIR}/src/dif/HorseTable.o: nbproject/Makefile-${CND_CONF}.mk src/dif/HorseTable.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/dif
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dif/HorseTable.o src/dif/HorseTable.cpp
...
${OBJECTDIR}/src/globals.o: nbproject/Makefile-${CND_CONF}.mk src/globals.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/globals.o src/globals.cpp

${OBJECTDIR}/src/hooks/CalcAttBonus.o: nbproject/Makefile-${CND_CONF}.mk src/hooks/CalcAttBonus.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/hooks
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/hooks/CalcAttBonus.o src/hooks/CalcAttBonus.cpp
...
${OBJECTDIR}/src/hooks/DoWar.o: nbproject/Makefile-${CND_CONF}.mk src/hooks/DoWar.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/hooks
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/hooks/DoWar.o src/hooks/DoWar.cpp

${OBJECTDIR}/src/hooks/DropGold.o: nbproject/Makefile-${CND_CONF}.mk src/hooks/DropGold.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/hooks
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/hooks/DropGold.o src/hooks/DropGold.cpp

${OBJECTDIR}/src/hooks/GiveExp.o: nbproject/Makefile-${CND_CONF}.mk src/hooks/GiveExp.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/hooks
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/hooks/GiveExp.o src/hooks/GiveExp.cpp

${OBJECTDIR}/src/hooks/HorseApply.o: nbproject/Makefile-${CND_CONF}.mk src/hooks/HorseApply.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/hooks
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/hooks/HorseApply.o src/hooks/HorseApply.cpp

${OBJECTDIR}/src/hooks/HorseVnum.o: nbproject/Makefile-${CND_CONF}.mk src/hooks/HorseVnum.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/hooks
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/hooks/HorseVnum.o src/hooks/HorseVnum.cpp

${OBJECTDIR}/src/hooks/NumberEx.o: nbproject/Makefile-${CND_CONF}.mk src/hooks/NumberEx.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/hooks
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/hooks/NumberEx.o src/hooks/NumberEx.cpp

${OBJECTDIR}/src/hooks/PointChange.o: nbproject/Makefile-${CND_CONF}.mk src/hooks/PointChange.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/hooks
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/hooks/PointChange.o src/hooks/PointChange.cpp

${OBJECTDIR}/src/hooks/SyncPosition.o: nbproject/Makefile-${CND_CONF}.mk src/hooks/SyncPosition.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/hooks
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/hooks/SyncPosition.o src/hooks/SyncPosition.cpp

${OBJECTDIR}/src/hooks/UseItemEx.o: nbproject/Makefile-${CND_CONF}.mk src/hooks/UseItemEx.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/hooks
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/hooks/UseItemEx.o src/hooks/UseItemEx.cpp

${OBJECTDIR}/src/libm2/Command.o: nbproject/Makefile-${CND_CONF}.mk src/libm2/Command.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/libm2
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/libm2/Command.o src/libm2/Command.cpp

${OBJECTDIR}/src/libm2/IQuest.o: nbproject/Makefile-${CND_CONF}.mk src/libm2/IQuest.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/libm2
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/libm2/IQuest.o src/libm2/IQuest.cpp
...
${OBJECTDIR}/src/libm2/lib/log.o: nbproject/Makefile-${CND_CONF}.mk src/libm2/lib/log.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/libm2/lib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/libm2/lib/log.o src/libm2/lib/log.cpp
...
${OBJECTDIR}/src/quest/item2.o: nbproject/Makefile-${CND_CONF}.mk src/quest/item2.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/quest/item2.o src/quest/item2.cpp

${OBJECTDIR}/src/quest/npc2.o: nbproject/Makefile-${CND_CONF}.mk src/quest/npc2.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/quest
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/quest/npc2.o src/quest/npc2.cpp

${OBJECTDIR}/src/quest/pc2.o: nbproject/Makefile-${CND_CONF}.mk src/quest/pc2.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/quest
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/quest/pc2.o src/quest/pc2.cpp
